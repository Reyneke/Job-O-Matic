...
| 7 | [CI/CD Pipeline](./7-CI-CD-Pipeline.md) | Continuous Integration & Deployment | ✅ |

---

## Offene Fragen

_Alle noch zu klärenden Fragen aus den Einzeldokumenten, inklusive Priorität, Status und Anmerkung:_

| # | Frage | Betroffenes Dokument | Priorität | Status | Anmerkung |
|---|-------|----------------------|-----------|--------|-----------|
...
| 2 | **Portal-Unterstützung priorisieren:** Welche Portale außer Jobcenter sollen unterstützt werden? Qualität der Portal-APIs prüfen. | `3-automailer.md` | 🟡 Mittel | 🔄 Offen | Unterstützung für: LinkedIn, Indeed, Stepstone, Monster |
| 3 | **Rechtliche Prüfung der Portal-Automation:** Ist automatisierte Portal-Eingabe mit den AGB der Portale vereinbar? Anwalt für IT-Recht einschalten. | `3-automailer.md` | 🔴 Hoch | ✅ Geklärt | Ja, mit AGB vereinbar. |
| 4 | **Mehrere E-Mail-Profile:** Sollen private Bewerbungen vs. Bewerbungen über Agentur getrennte Profile erhalten? | `3-automailer.md` | 🟢 Niedrig | ⏳ Verschoben | Private/Agentur-Trennung für nächsten Release-Zyklus vorgemerkt. |
| 5 | **Web-Kompatibilität der Datenbank:** `sqflite_common_ffi_web` ist noch experimentell. Alternativ `drift` mit WebSQL-Fallback? | `6-Datenbank-Persistenz.md` | 🟡 Mittel | ✅ Geklärt | Nach Rücksprache: SQFlite. |
| 6 | **Verschlüsselung der gesamten DB:** Soll `sqlcipher` für sensible Bewerbungsdaten verwendet werden? | `6-Datenbank-Persistenz.md` | 🟢 Niedrig | ✅ Geklärt | `sqlcipher`-Integration in DB-Schema-Schicht vorgesehen. |
| 7 | **Backup/Export der DB:** Soll der Nutzer Daten (Applications, CV) als JSON exportieren können? | `6-Datenbank-Persistenz.md` | 🟢 Niedrig | ✅ Geklärt | Export-Funktion in Einstellungen → Datenverwaltung geplant. |
| 8 | **Auto-Delete alter Einträge:** Alte Bewerbungen (> 6 Monate) automatisch bereinigen? (Speicherplatz-Optimierung) | `6-Datenbank-Persistenz.md` | 🟢 Niedrig | ✅ Geklärt | Autom. Bereinigung via Scheduled-Task nach 6 Monaten. |
| 9 | **Sync mit Cloud:** Soll die DB später mit einem Cloud-Backend synchronisiert werden? (Beeinflusst Schema-Design) | `6-Datenbank-Persistenz.md` | 🟢 Niedrig | ⏳ Verschoben | Schema muss Cloud-Sync-fähig designed werden. |
| 10 | **iOS-Builds:** Apple Developer-Account erforderlich ($99/Jahr). Wie gehen wir mit Code-Signing um? (Manuell vs. CI) | `7-CI/CD Pipeline.md` | 🟡 Mittel | ⏳ Verschoben | Code-Signing über GitHub Actions + Fastlane Match. |
| 11 | **Store-Deployment:** Soll die Pipeline automatisch in Google Play Store / Apple App Store / Microsoft Store veröffentlichen? | `7-CI/CD Pipeline.md` | 🟡 Mittel | ⏳ Verschoben | Veröffentlichung über GitHub Actions + Supply/App Store Connect API. |
| 12 | **Web-Hosting:** GitHub Pages vs. professionelleres Hosting (Netlify, Firebase Hosting, Vercel)? | `7-CI/CD Pipeline.md` | 🟡 Mittel | ✅ Geklärt | GitHub Pages für Phase 1, Netlify für Produktion. |
| 13 | **Code-Signing für Desktop:** Windows: SignTool-Zertifikat (~200 €/Jahr). macOS: Notarization. Linux: AppImage/Snap? | `7-CI/CD Pipeline.md` | 🟢 Niedrig | ⏳ Verschoben | Windows: SignTool-Zertifikat erforderlich. macOS: Notarization über CI. |
| 14 | **Test-Devices:** Werden echte Geräte/Emulatoren für Integrationstests benötigt? (Firebase Test Lab, BrowserStack) | `7-CI/CD Pipeline.md` | 🟢 Niedrig | ✅ Geklärt | Firebase Test Lab für Android, lokal für Web/Desktop. |
| 15 | **CHANGELOG.md:** Release-Notes-Datei muss noch erstellt und gepflegt werden. | `7-CI/CD Pipeline.md` | 🟡 Mittel | ✅ Geklärt | CHANGELOG.md wird im Release-Workflow automatisch generiert. |
| 16 | **Code-Coverage-Threshold:** Ab welchem Wert soll die Pipeline fehlschlagen? | `7-CI/CD Pipeline.md` | 🟢 Niedrig | ✅ Geklärt | 60 % Phase 1, 80 % Produktion. |
...
| Deadline | Priorität | Aufgabe | Dokumentation | Abhängigkeiten |
|----------|-----------|---------|---------------|----------------|
...
| KW 31 | 🔴 | Abhängigkeiten installieren (`flutter pub get`) | `2-Workflow.md` Schritt 1 | — |
...
5. 🔄 Offene Fragen mit Status 🔄 (insbesondere Portal-Unterstützung priorisieren) klären – *vor Sprint 3*
